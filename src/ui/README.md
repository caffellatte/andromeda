...
| Meter | `value`, `min`, `max`, `orientation`, `width`, `height`, `label`, `unit`, `showValue`, `disabled`, `tooltipText`, `className` | `orientation` default `horizontal`; `min/max` default `0/1`; use `width/height` for layout |
